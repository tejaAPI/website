							...
							<div class="login-grids">
									<div class="login-bottom">
										...
										<form action="#" method="post">
											<div class="sign-up">
												<h4>Reg No :</h4>
												<input type="text" name="lname" value="Enter registration number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type here';}" required="">	
											</div>
											<div class="sign-up">
											...
											<div class="sign-up">
												<h4>Email :</h4>
												<input type="email" name="Password" value="Email" class="form-control" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
...
<?php
  ...
  if(array_key_exists("uname", $_POST) OR array_key_exists("pwd", $_POST)){

    if($_POST["uname"] == ''){

      print_r("Email Id is required<br>");
    }
    ...
    elseif($_POST["pwd"] == ''){
      ...
      $query = "SELECT * FROM  `users` WHERE `email` = '".$_POST['uname']."'";
      #echo $query;
      ...
      if(mysqli_num_rows($result) > 0){
        ...
        $query = "SELECT * FROM  `users` WHERE `password` = '".$pwd."' and `email` = '".$uname."'";
        $result = mysqli_query($link, $query);
        if(mysqli_num_rows($result) == 1){
          print_r("Login successfull");
          header("Location: my/main.html");
        }
        else{

          print_r("Wrong Password! Please try again.");
        }
      }
    
      else{

        echo "Login unsuccessfull!	Please Sign Up first!";
      }
    }
  }
?>	